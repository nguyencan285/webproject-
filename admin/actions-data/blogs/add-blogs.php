...
<body>
    <?php include '../auth-role-admin.php'; ?>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <span style="display: block;">KeyWord</span>
    ...
    if($_SERVER['REQUEST_METHOD']==='POST'){
        ...
        if(isset($_POST['add-blogs']) && !empty($_POST['keyword']) && !empty($_POST['content']) && !empty($_FILES['image']) && !empty($_POST['title']) && !empty($_POST['description']) && !empty($_POST['categoryblog'])){
            $sql = "INSERT INTO blogs (`categoryblog`,`image`,`title`,`description`,`content`,`keyword`,`createdate`) 
                    VALUES (?,?,?,?,?,?,?)"; // Tạo câu lệnh và gán giá trị ẩn
            if($stmt = mysqli_prepare($conn, $sql)){ // Tạo câu lệnh chuẩn bị
                ...
                mysqli_stmt_bind_param($stmt,"sssssss", $categoryblog, $image, $title, $description, $content, $keyword,$createdate);// gán giá trị vào
